...
ggsave("../images/GDPvsYears.png", width = 5, height = 5)
...
ggplot(Natural_Disasters,aes(year,cost)) + 
  ...
  ggtitle("Most Damaging Natural Disasters per Year")
...
ggsave("../images/Pokemon_per_Type.png")
ggsave("../images/Pokemon_per_Type.pdf")
```
...
ggsave("../images/Pokemon_Power_per_Type.png")
ggsave("../images/Pokemon_Power_per_Type.pdf")
```
...
ggsave("../images/Avg_Pokemon_Power_per_Type.png")
ggsave("../images/Avg_Pokemon_Power_per_Type.pdf")
```
...
ggsave("../images/Disasters_per_Type.png")
ggsave("../images/Disasters_per_Type.pdf")
```
...
ggplot(data = natural_disasters, 
       aes(year, casualty)) + 
  geom_bar(stat = "identity") 
ggsave("../images/Disasters_Type_and_Casualties_per_Type.png")
ggsave("../images/Disasters_Type_and_Casualties_per_Type.pdf")
```
...
ggsave("../images/Economic_Cost_vs_Disasters.png")
ggsave("../images/Economic_Cost_vs_Disasters.pdf")
```
...
ggsave("../images/Casualties_per_Disaster.png")
ggsave("../images/Casualties_per_Disaster.pdf")
```
...
ggsave("../images/Cost_per_Disaster.png")
ggsave("../images/Cost_per_Disaster.pdf")
```
...
ggsave("../images/Disaster_Occurences.png")
ggsave("../images/Disaster_Occurences.pdf")
```
